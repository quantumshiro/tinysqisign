...
def main() -> int:
    ...
    pareto_json_path = args.audit_output.parent / "resource-time-pareto.json"
    pareto_csv_path = args.audit_output.parent / "resource-time-pareto.csv"
    pareto_report = {
        "schema": "tinysqisign-v2-resource-time-pareto-v1",
        "status": "PASS",
