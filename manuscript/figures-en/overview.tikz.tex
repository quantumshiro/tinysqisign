% Monochrome overview for the English manuscript.
\begin{tikzpicture}[
  x=1mm,y=1mm,
  ...
  \node[title] at (48,0) {(b) lifetime};
  \node[title] at (81,0) {(c) v2 sketch};
  \node[title] at (116,0) {(d) RP2350};
  \node[title] at (151,0) {(e) claims};
  ...
  \node[strong,fill=white,inner sep=.4mm] at (15,-10) {6.34 MB};
  ...
  \node[box,text width=18mm,line width=.85pt] (full) at (76,-30) {$N_i\ ?\ N_j$};
  \node[box,text width=9mm] (ord) at (94,-15) {order};
  \draw[flow] (sk.east) -- node[lab,above] {$\neq$} (ord.west);
  \draw[flow] (sk.south) -- node[lab,right] {$=$} (full.north);
  \draw[flow] (full.east) -| (ord.south);

  \node[box,text width=20mm] (v2) at (116,-14) {v2 proposed\\172 kB};
  \node[box,text width=20mm] (v3) at (116,-30) {v3 D3\\$-4.7$ kB};

  \node[strong] at (151,-12) {function $\checkmark$};
  \node[lab] at (151,-17) {memory $\checkmark$};
  \draw[dashed,line width=.8pt] (138,-22) -- (164,-22);
  \node[strong] at (151,-28) {constant time $\times$};
  \node[lab] at (151,-34) {power/EM ?};

  \draw[flow] (24.5,-22) -- (33.5,-22);
  \draw[flow] (63,-17) -- (66,-17);
  \draw[flow] (99,-15) -- (103,-15);
  \draw[flow] (63,-24) |- (103,-30);
