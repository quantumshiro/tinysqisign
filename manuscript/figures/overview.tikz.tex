...
% Qualifications and exact measurement boundaries remain in the caption/text.
\begin{tikzpicture}[
  x=1mm,y=1mm,
  ...
  % (c) The v2-only sketch has a mandatory exact fallback.
  ...
  \node[box,text width=20mm] (v3) at (116,-30) {v3適応実装\\$-3.9$ kB};
